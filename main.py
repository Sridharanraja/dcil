...
# #### **Why Only 50 Epochs?**
# Due to Colab’s time/resource constraints, training was capped at 50 epochs. The model still achieved high generalization and precision.
...
# Robust against varying sizes and lighting. Most errors from cluttered backgrounds.
