...
model = load_model(model_file, conf_thresh)
...
report_text = """
### **YOLOv11 Object Detection - Model Training Report**
... [Your full training report here] ...
"""
...
if input_file is not None:
    if data_type == "Image":
        ...
        while cap.isOpened():
            ...
            stframe.image(results.ims[0], channels="RGB", use_column_width=True)
